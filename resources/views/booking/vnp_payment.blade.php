...
<body>
    ...
    <div class="container">
        ...
        <div class="table-responsive">
            <form action="{{ route('handleVnpPayment') }}" id="create_form" method="post">
                @csrf
                <div class="form-group">
                    <label for="language">Loại hàng hóa </label>
                    <select name="order_type" id="order_type" class="form-control">
                        <option value="170000">Thanh toán dịch vụ du lịch</option>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" cols="20" id="order_desc" name="order_desc" rows="2">Thanh toan tour</textarea>
                </div>
                <div class="form-group">

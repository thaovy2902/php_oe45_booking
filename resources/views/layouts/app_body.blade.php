...
<head>
	...
	<!-- Styles-->
	<link rel="stylesheet" href="{{ mix('/assets/template/css/style.css') }}">
	<link rel="stylesheet" href="{{ mix('/assets/template/css/header.css') }}">
	<link rel="stylesheet" href="{{ mix('/assets/template/css/bookingForm.css') }}">
	<link rel="stylesheet" href="{{ mix('/assets/template/css/style2.css') }}">
	<link rel="stylesheet" href="{{ mix('/assets/template/css/superfish.css') }}">
	<link rel="stylesheet" href="{{ mix('/assets/template/css/bootstrap.css') }}">
	<link rel="stylesheet" href="{{ mix('/assets/template/css/custom-heart.css') }}">
	...
	<script src="{{ mix('/assets/template/js/modernizr-2.6.2.min.js') }}"></script>
	<script src="{{ mix('/assets/template/js/main.js') }}"></script>

...
<head>
	...
	<link rel="stylesheet" href="{{ mix('/assets/css/bootstrap-datepicker.min.css') }}">
	<link rel="stylesheet" href="{{ mix('/assets/css/icomoon.css') }}">
	<link rel="stylesheet" href="{{ mix('/assets/css/effects.css') }}">
	<link rel="stylesheet" href="{{ mix('/assets/css/cs-select.css') }}">
	<link rel="stylesheet" href="{{ mix('/assets/css/cs-skin-border.css') }}">
	<!-- JavaScript-->
	<script src="{{ mix('assets/js/all-js.js') }}"></script>
	<script src="{{ mix('assets/js/bootstrap-datepicker.min.js') }}"></script>
